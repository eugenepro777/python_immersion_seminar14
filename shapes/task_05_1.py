...
class TestRectangle(unittest.TestCase):
    def test_area(self):
        self.assertEqual(Rectangle.get_area(Rectangle(3, 4)), 12)

    def test_sub(self):
        self.assertEqual(str(Rectangle(3, 4) - Rectangle(3, 4)), 'Прямоугольник со сторонами 0 и 0')

    def test_gt(self):
        self.assertEqual((Rectangle(3, 4) > Rectangle(1, 2)), True)
